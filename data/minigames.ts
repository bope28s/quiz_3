...
export const minigames: Minigame[] = [
  // 점프 게임들
  {
    ...
    instructions: '화면을 터치하거나 클릭해서 장애물을 뛰어넘어보세요! 6개를 넘으면 성공!',
    data: {
      obstacles: 6,
      speed: 1.0,
      jumpHeight: 100
    ...
    storyText: '🏃‍♂️ 마법사가 나타났습니다. "화면을 터치하거나 클릭해서 점프해서 장애물을 뛰어넘어보시오! 6개를 넘으면 성공이오!"'
  },
  ...
  // 잡기 게임들
  {
    ...
    instructions: '화면을 터치하거나 드래그해서 떨어지는 별들을 잡아보세요! 10개를 잡으면 성공!',
    data: {
      targets: 10,
      fallSpeed: 2.0,
      spawnRate: 1.5
    ...
    storyText: '⭐ 마법사가 나타났습니다. "화면을 터치하거나 드래그해서 떨어지는 별들을 잡아보시오! 10개를 잡으면 성공이오!"'
  },
  ...
  // 피하기 게임들
  {
    ...
    instructions: '화면을 터치하거나 드래그해서 움직여서 떨어지는 돌들을 피해보세요! 20초 동안 살아남으면 성공!',
    data: {
      duration: 20,
      obstacleSpeed: 3.0,
      spawnRate: 2.0
    ...
    storyText: '🪨 마법사가 나타났습니다. "화면을 터치하거나 드래그해서 움직여서 떨어지는 돌들을 피해보시오! 20초 동안 살아남으면 성공이오!"'
  },
  ...
  // 수집 게임들
  {
    ...
    instructions: '화면을 터치하거나 드래그해서 움직여서 보물들을 수집해보세요! 12개를 모으면 성공!',
    data: {
      treasures: 12,
      playerSpeed: 2.5,
      treasureSpawn: 1.0
    ...
    storyText: '💎 마법사가 나타났습니다. "화면을 터치하거나 드래그해서 움직여서 보물들을 수집해보시오! 12개를 모으면 성공이오!"'
  },
  ...
  // 슈팅 게임들
  {
    ...
    instructions: '화면을 터치하거나 클릭해서 날아오는 몬스터들을 쏘아보세요! 15마리를 잡으면 성공!',
    data: {
      targets: 15,
      bulletSpeed: 5.0,
      enemySpeed: 2.0
    ...
    storyText: '🏹 마법사가 나타났습니다. "화면을 터치하거나 클릭해서 날아오는 몬스터들을 쏘아보시오! 15마리를 잡으면 성공이오!"'
  }
];
