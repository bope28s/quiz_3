...
export const wizardDialogues: WizardDialogue[] = [
  {
    ...
    dialogues: {
      ...
      afterIncorrect: "괜찮습니다! 숫자는 연습이 필요해요. 힌트 버튼을 눌러서 도움을 받아보세요!",
      beforeMinigame: "특별한 게임을 준비했습니다! 성공하면 다음 단계를 건너뛸 수 있어요!",
  ...
  },
  {
    ...
    dialogues: {
      ...
      afterIncorrect: "한글은 우리의 소중한 언어입니다. 힌트 버튼을 눌러서 도움을 받아보세요!",
      beforeMinigame: "🎮 마법의 플래시 게임을 준비했습니다! 점프, 잡기, 피하기, 수집, 슈팅 중 하나가 랜덤으로 나타날 거예요! 성공하면 다음 단계를 건너뛸 수 있어요!",
  ...
  },
  {
    ...
    dialogues: {
      ...
      afterIncorrect: "기하학은 세상의 아름다운 구조를 보여줍니다. 힌트 버튼을 눌러서 도움을 받아보세요!",
      beforeMinigame: "특별한 게임을 준비했습니다! 성공하면 다음 단계를 건너뛸 수 있어요!",
      afterMinigameSuccess: "훌륭한 실력이군요! 다음 단계로 바로 넘어갈 수 있습니다!",
      afterMinigameFailure: "아쉽게도 게임에서 실패했네요. 하지만 괜찮습니다! 퀴즈를 풀어보세요!",
  ...
  },
  {
    ...
    dialogues: {
      ...
      afterIncorrect: "문학은 마음의 양식입니다. 힌트 버튼을 눌러서 도움을 받아보세요!",
      beforeMinigame: "특별한 게임을 준비했습니다! 성공하면 다음 단계를 건너뛸 수 있어요!",
      afterMinigameSuccess: "훌륭한 실력이군요! 다음 단계로 바로 넘어갈 수 있습니다!",
      afterMinigameFailure: "아쉽게도 게임에서 실패했네요. 하지만 괜찮습니다! 퀴즈를 풀어보세요!",
  ...
  },
  {
    ...
    dialogues: {
      ...
      afterIncorrect: "역사는 우리의 뿌리입니다. 힌트 버튼을 눌러서 도움을 받아보세요!",
      beforeMinigame: "🎮 역사의 마법으로 플래시 게임을 준비했습니다! 점프, 잡기, 피하기, 수집, 슈팅 중 하나가 랜덤으로 나타날 거예요! 성공하면 다음 단계를 건너뛸 수 있어요!",
  ...
  },
  {
    ...
    dialogues: {
      ...
      afterIncorrect: "과학은 세상의 비밀을 밝혀줍니다. 힌트 버튼을 눌러서 도움을 받아보세요!",
      beforeMinigame: "특별한 게임을 준비했습니다! 성공하면 다음 단계를 건너뛸 수 있어요!",
      afterMinigameSuccess: "훌륭한 실력이군요! 다음 단계로 바로 넘어갈 수 있습니다!",
      afterMinigameFailure: "아쉽게도 게임에서 실패했네요. 하지만 괜찮습니다! 퀴즈를 풀어보세요!",
  ...
  },
  {
    ...
    dialogues: {
      ...
      afterIncorrect: "예술은 마음의 아름다움을 표현합니다. 힌트 버튼을 눌러서 도움을 받아보세요!",
      beforeMinigame: "특별한 게임을 준비했습니다! 성공하면 다음 단계를 건너뛸 수 있어요!",
      afterMinigameSuccess: "훌륭한 실력이군요! 다음 단계로 바로 넘어갈 수 있습니다!",
      afterMinigameFailure: "아쉽게도 게임에서 실패했네요. 하지만 괜찮습니다! 퀴즈를 풀어보세요!",
