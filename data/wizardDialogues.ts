...
export const wizardDialogues: WizardDialogue[] = [
  ...
  },
  {
    ...
    dialogues: {
      ...
      beforeMinigame: "🎮 마법의 플래시 게임을 준비했습니다! 점프, 잡기, 피하기, 수집, 슈팅 중 하나가 랜덤으로 나타날 거예요! 화면을 터치하거나 드래그해서 조작하세요! 성공하면 이번 단계를 건너뛸 수 있어요!",
  ...
  },
  {
    ...
    dialogues: {
      ...
      beforeMinigame: "🎮 역사의 마법으로 플래시 게임을 준비했습니다! 점프, 잡기, 피하기, 수집, 슈팅 중 하나가 랜덤으로 나타날 거예요! 화면을 터치하거나 드래그해서 조작하세요! 성공하면 이번 단계를 건너뛸 수 있어요!",
